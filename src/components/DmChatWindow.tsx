...
export default function DmChatWindow({ conversationId, otherUserId, otherAlias, onMenuToggle, onBack, isMobile }: Props) {
  const { user } = useAuth()
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', background: '#fff', paddingTop: 'max(env(safe-area-inset-top, 0px), 12px)' }}>
      {/* Header */}
      <div
        style={{
          padding: '12px 16px',
